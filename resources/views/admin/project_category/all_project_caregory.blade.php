                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Create Project category</a></li>
                                <li class="breadcrumb-item active">Project Category All Tables</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Project Category All</h4>
                            <p>
                                <br>
                            </p>
                                    ...
                                    @foreach ($projectCategory as $item)
                                        <tr >
                                            <td>{{ $i++ }}</td>
                                                ...
                                                <a href="{{route('edit.project.category', $item->id)}}" class="btn btn-info sm" title="Edit Data"><i class="fas fa-edit"></i></a>
                                                <a href="{{route('delete.project.category', $item->id)}}" class="btn btn-danger sm delete-btn" title="Delete Data"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
