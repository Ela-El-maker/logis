            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">All Useful Items List</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Create Image</a></li>
                                <li class="breadcrumb-item active">Useful Tables</li>
                            </ol>
                        </div>

                        <a href="{{route('add.useful')}}">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title">All Useful Links List</h4>
                            <p>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($allItems as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->useful_title }}</td>
                                            <td>{{ $item->useful_url }}</td>
                                            
                                            <td style="width: 150px;"> <!-- Adjust the width as needed -->
                                                <a href="{{ route('edit.useful', $item->id) }}" class="btn btn-info sm"
                                                    title="Edit Data"><i class="fas fa-edit"></i></a>
                                                <a href="{{ route('delete.useful', $item->id) }}"
