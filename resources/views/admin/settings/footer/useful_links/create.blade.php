            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <h4 class="card-title">Add Useful Links Section Page</h4><br><br>

                            <form action="{{route('store.useful')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="useful_title" type="text" value=""
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="useful_url" type="text" value=""
                                            id="example-text-input">
