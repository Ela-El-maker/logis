            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">All Social Items List</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Create Image</a></li>
                                <li class="breadcrumb-item active">Social Tables</li>
                            </ol>
                        </div>

                        <a href="{{route('add.social')}}">
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($allItems as $item)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td><i class="{{ $item->social_icon }}" style="font-size: 20px;"></i></td>
                                            <td>{{ $item->social_url }}</td>

                                            <td style="width: 150px;"> <!-- Adjust the width as needed -->
                                                <a href="{{ route('edit.social', $item->id) }}" class="btn btn-info sm"
