                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-floating">
                                            ...
                                            <textarea class="form-control" name="sub_title" type="text" placeholder="Leave a Sub title here"
                                                id="example-text-input" style="height: 100px">{{$aboutPage->sub_title}}</textarea>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="video_url" type="text"
                                            value="{{$aboutPage->video_url}}" id="example-text-input">
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label for="image-upload" class="col-sm-2 col-form-label">About Foreground Image</label>

                                    <div class="col-sm-10">
                                        <div id="image-preview">
                                            <img id="preview-img" src="{{ !empty($aboutPage->foreground_image) ? url( $aboutPage->foreground_image) : url('uploads/no_image.jpg') }}" alt="Slide Image"
                                            ...
                                            <label for="image-upload" id="image-label" class="btn btn-primary">Choose
                                                File</label>
                                            <input type="file" name="foreground_image" id="image-upload"
