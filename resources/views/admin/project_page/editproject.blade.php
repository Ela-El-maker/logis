                            ...
                            <form action="{{route('update.project')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        data-icon="{{$editProject->project_icon}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <textarea class="form-control" name="project_sub_title" type="text" placeholder="Leave a Sub title here"
                                            id="example-text-input" style="height: 100px">
                                            {!!$editProject->project_sub_title!!}
                                        </textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="image-preview">
                                            <img id="preview-img" src="{{ !empty($editProject->project_image) ? url( $editProject->project_image) : url('uploads/no_image.jpg') }}" alt="Slide Image"
