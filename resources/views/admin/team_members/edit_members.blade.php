            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <h4 class="card-title">Edit Team Member Section Page</h4><br><br>

                            <form action="{{route('update.member')}}" method="post" enctype="multipart/form-data">
                                @csrf


                                <input type="hidden" name="id" value="{{$editMembers->id}}">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="team_member_name" type="text"
                                            value="{{$editMembers->team_member_name}}" id="example-text-input">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="image-preview">
                                            <img id="preview-img"
                                                 src="{{ !empty($editMembers->team_member_image) ? url($editMembers->team_member_image) : url('uploads/no_image.jpg') }}"
                                                 alt="Slide Image"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="team_member_position" type="text"
                                            value="{{$editMembers->team_member_position}}" id="example-text-input">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="team_member_twitter" type="text"
                                            value="{{$editMembers->team_member_twitter}}" id="example-text-input">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="team_member_instagram" type="text"
                                            value="{{$editMembers->team_member_instagram}}" id="example-text-input">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="team_member_linkedIn" type="text"
                                            value="{{$editMembers->team_member_linkedIn}}" id="example-text-input">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1" name="team_member_speech">{{$editMembers->team_member_speech}}</textarea>
